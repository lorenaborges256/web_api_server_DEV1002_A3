...
The inventory management web server was designed to meet deployment, functionality, and data integrity standards. It is available at a publicly accessible endpoint via **Render** and can also be run locally through **Flask**. This dual setup ensures consistency between development and production environments.

### Deployment & Functionality
- Publicly accessible via Render [(https://web-api-server-dev1002-a3.onrender.com)] 
